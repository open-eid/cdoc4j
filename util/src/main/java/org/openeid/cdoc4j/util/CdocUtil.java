...
import org.openeid.cdoc4j.util.commands.Decrypt;
...
@Command(
    ...
    customSynopsis = { "[encrypt|decrypt|pkcs11-decrypt] <arguments>" },
    subcommands = {Encrypt.class, Decrypt.class, PKCS11Decrypt.class}
)
public class CdocUtil implements Callable<Void> {
  ...
  public static void main(String... args) {
    if (args.length == 0) {
      ...
      CommandLine.usage(new Decrypt(), System.out);
